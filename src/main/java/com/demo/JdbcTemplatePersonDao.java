...
public class JdbcTemplatePersonDao implements Dao<Person> {
    ...
    public long save(Person person) {
        String sql = "insert into Person (first_Name, Last_Name, Address,SOURCE_MESSAGE) values (?, ?, ?,?)";
        ...
        jdbcTemplate.update(
                connection -> {
                    ...
                    ps.setBlob(4, new ByteArrayInputStream(person.getImage()));
                    return ps;
                }, keyHolder);
    ...
    private Person toPerson(ResultSet resultSet) throws SQLException {
        ...
        Blob blob = resultSet.getBlob("SOURCE_MESSAGE");
